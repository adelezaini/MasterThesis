...
# IDEAL-ON case: 
# - idealized vegetation shift, with interactive BVOC
...
export CASENAME=IDEAL-ON_2000_f19_f19
export SPINUP_CASENAME=IDEAL_2000_spinup_f19_f19
...
#echo -e " fsurdat = '/cluster/home/adelez/noresm-inputdata/surfdata_1.9x2.5_hist_78pfts_CMIP6_simyr2000_c190304_edited.nc'">> user_nl_clm
